...
bool FlyByWireInterface::getModelInputDataFromSim(double sampleTime) {
  ...
  set_named_variable_value(idFlightDirectorBank, -1.0 * simInputClientData.flightDirectorPhi);
  set_named_variable_value(idFlightDirectorPitch, -1.0 * simInputClientData.flightDirectorTheta);
