...
impl Default for A320FlightWarningComputerRuntime {
    fn default() -> Self {
        Self {
            ...
            new_ground_def: Default::default(),
            ground_detection: Default::default(),
            speed_detection: Default::default(),
            engines_not_running: Default::default(),
            both_engine_running: Default::default(),
            altitude_def: Default::default(),
            eng_take_off_cfm: Default::default(),
            tla_pwr_reverse: Default::default(),
            tla_at_mct_or_flex_to_cfm: Default::default(),
            tla_at_cl_cfm: Default::default(),
            neo_ecu: Default::default(),
            cfm_flight_phases: Default::default(),
            flight_phases_ground: Default::default(),
            flight_phases_air: Default::default(),
